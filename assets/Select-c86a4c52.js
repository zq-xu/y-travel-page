...
`,[L("scrollbar",`
 ...
 `,[Mt({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),To=Object.assign(Object.assign({},Te.props),{to:at.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),Ao=ce({name:"Select",props:To,setup(e){const{mergedClsPrefixRef:t,mergedBorderedRef:n,namespaceRef:o,inlineThemeDisabled:l}=pn(e),s=Te("Select","-select",Co,Sn,e,t),a=z(e.defaultValue),r=te(e,"value"),y=pt(r,a),v=z(!1),h=z(""),C=W(()=>{const{valueField:i,childrenField:f}=e,O=wo(i,f);return vo(w.value,O)}),R=W(()=>So(N.value,e.valueField,e.childrenField)),D=z(!1),g=pt(te(e,"show"),D),k=z(null),V=z(null),T=z(null),{localeRef:F}=Fn("Select"),M=W(()=>{var i;return(i=e.placeholder)!==null&&i!==void 0?i:F.value.placeholder}),p=On(e,["items","options"]),x=[],P=z([]),B=z([]),H=z(new Map),U=W(()=>{const{fallbackOption:i}=e;if(i===void 0){const{labelField:f,valueField:O}=e;return $=>({[f]:String($),[O]:$})}return i===!1?!1:f=>Object.assign(i(f),{value:f})}),N=W(()=>B.value.concat(P.value).concat(p.value)),b=W(()=>{const{filter:i}=e;if(i)return i;const{labelField:f,valueField:O}=e;return($,A)=>{if(!A)return!1;const I=A[f];if(typeof I=="string")return it($,I);const _=A[O];return typeof _=="string"?it($,_):typeof _=="number"?it($,String(_)):!1}}),w=W(()=>{if(e.remote)return p.value;{const{value:i}=N,{value:f}=h;return!f.length||!e.filterable?i:xo(i,b.value,f,e.childrenField)}});function E(i){const f=e.remote,{value:O}=H,{value:$}=R,{value:A}=U,I=[];return i.forEach(_=>{if($.has(_))I.push($.get(_));else if(f&&O.has(_))I.push(O.get(_));else if(A){const Q=A(_);Q&&I.push(Q)}}),I}const q=W(()=>{if(e.multiple){const{value:i}=y;return Array.isArray(i)?E(i):[]}return null}),Y=W(()=>{const{value:i}=y;return!e.multiple&&!Array.isArray(i)?i===null?null:E([i])[0]||null:null}),G=mn(e),{mergedSizeRef:K,mergedDisabledRef:J,mergedStatusRef:u}=G;function m(i,f){const{onChange:O,"onUpdate:value":$,onUpdateValue:A}=e,{nTriggerFormChange:I,nTriggerFormInput:_}=G;O&&re(O,i,f),A&&re(A,i,f),$&&re($,i,f),a.value=i,I(),_()}function j(i){const{onBlur:f}=e,{nTriggerFormBlur:O}=G;f&&re(f,i),O()}function ee(){const{onClear:i}=e;i&&re(i)}function se(i){const{onFocus:f,showOnFocus:O}=e,{nTriggerFormFocus:$}=G;f&&re(f,i),$(),O&&ue()}function ke(i){const{onSearch:f}=e;f&&re(f,i)}function Fe(i){const{onScroll:f}=e;f&&re(f,i)}function pe(){var i;const{remote:f,multiple:O}=e;if(f){const{value:$}=H;if(O){const{valueField:A}=e;(i=q.value)===null||i===void 0||i.forEach(I=>{$.set(I[A],I)})}else{const A=Y.value;A&&$.set(A[e.valueField],A)}}}function me(i){const{onUpdateShow:f,"onUpdate:show":O}=e;f&&re(f,i),O&&re(O,i),D.value=i}function ue(){J.value||(me(!0),D.value=!0,e.filterable&&Be())}function ne(){me(!1)}function ye(){h.value="",B.value=x}const fe=z(!1);function Oe(){e.filterable&&(fe.value=!0)}function ve(){e.filterable&&(fe.value=!1,g.value||ye())}function ge(){J.value||(g.value?e.filterable?Be():ne():ue())}function Re(i){var f,O;!((O=(f=T.value)===null||f===void 0?void 0:f.selfRef)===null||O===void 0)&&O.contains(i.relatedTarget)||(v.value=!1,j(i),ne())}function Me(i){se(i),v.value=!0}function Pe(i){v.value=!0}function we(i){var f;!((f=k.value)===null||f===void 0)&&f.$el.contains(i.relatedTarget)||(v.value=!1,j(i),ne())}function xe(){var i;(i=k.value)===null||i===void 0||i.focus(),ne()}function ie(i){var f;g.value&&(!((f=k.value)===null||f===void 0)&&f.$el.contains(Cn(i))||ne())}function d(i){if(!Array.isArray(i))return[];if(U.value)return Array.from(i);{const{remote:f}=e,{value:O}=R;if(f){const{value:$}=H;return i.filter(A=>O.has(A)||$.has(A))}else return i.filter($=>O.has($))}}function S(i){Z(i.rawNode)}function Z(i){if(J.value)return;const{tag:f,remote:O,clearFilterAfterSelect:$,valueField:A}=e;if(f&&!O){const{value:I}=B,_=I[0]||null;if(_){const Q=P.value;Q.length?Q.push(_):P.value=[_],B.value=x}}if(O&&H.value.set(i[A],i),e.multiple){const I=d(y.value),_=I.findIndex(Q=>Q===i[A]);if(~_){if(I.splice(_,1),f&&!O){const Q=Ie(i[A]);~Q&&(P.value.splice(Q,1),$&&(h.value=""))}}else I.push(i[A]),$&&(h.value="");m(I,E(I))}else{if(f&&!O){const I=Ie(i[A]);~I?P.value=[P.value[I]]:P.value=x}_e(),ne(),m(i[A],i)}}function Ie(i){return P.value.findIndex(O=>O[e.valueField]===i)}function je(i){g.value||ue();const{value:f}=i.target;h.value=f;const{tag:O,remote:$}=e;if(ke(f),O&&!$){if(!f){B.value=x;return}const{onCreate:A}=e,I=A?A(f):{[e.labelField]:f,[e.valueField]:f},{valueField:_,labelField:Q}=e;p.value.some(le=>le[_]===I[_]||le[Q]===I[Q])||P.value.some(le=>le[_]===I[_]||le[Q]===I[Q])?B.value=x:B.value=[I]}}function He(i){i.stopPropagation();const{multiple:f}=e;!f&&e.filterable&&ne(),ee(),f?m([],[]):m(null,null)}function Ge(i){!De(i,"action")&&!De(i,"empty")&&i.preventDefault()}function Ue(i){Fe(i)}function Ae(i){var f,O,$,A,I;if(!e.keyboard){i.preventDefault();return}switch(i.key){case" ":if(e.filterable)break;i.preventDefault();case"Enter":if(!(!((f=k.value)===null||f===void 0)&&f.isComposing)){if(g.value){const _=(O=T.value)===null||O===void 0?void 0:O.getPendingTmNode();_?S(_):e.filterable||(ne(),_e())}else if(ue(),e.tag&&fe.value){const _=B.value[0];if(_){const Q=_[e.valueField],{value:le}=y;e.multiple&&Array.isArray(le)&&le.some(Xe=>Xe===Q)||Z(_)}}}i.preventDefault();break;case"ArrowUp":if(i.preventDefault(),e.loading)return;g.value&&(($=T.value)===null||$===void 0||$.prev());break;case"ArrowDown":if(i.preventDefault(),e.loading)return;g.value?(A=T.value)===null||A===void 0||A.next():ue();break;case"Escape":g.value&&(Tn(i),ne()),(I=k.value)===null||I===void 0||I.focus();break}}function _e(){var i;(i=k.value)===null||i===void 0||i.focus()}function Be(){var i;(i=k.value)===null||i===void 0||i.focusInput()}function qe(){var i;g.value&&((i=V.value)===null||i===void 0||i.syncPosition())}pe(),Ce(te(e,"options"),pe);const Ye={focus:()=>{var i;(i=k.value)===null||i===void 0||i.focus()},focusInput:()=>{var i;(i=k.value)===null||i===void 0||i.focusInput()},blur:()=>{var i;(i=k.value)===null||i===void 0||i.blur()},blurInput:()=>{var i;(i=k.value)===null||i===void 0||i.blurInput()}},Ne=W(()=>{const{self:{menuBoxShadow:i}}=s.value;return{"--n-menu-box-shadow":i}}),he=l?dt("select",void 0,Ne,e):void 0;return Object.assign(Object.assign({},Ye),{mergedStatus:u,mergedClsPrefix:t,mergedBordered:n,namespace:o,treeMate:C,isMounted:yn(),triggerRef:k,menuRef:T,pattern:h,uncontrolledShow:D,mergedShow:g,adjustedTo:at(e),uncontrolledValue:a,mergedValue:y,followerRef:V,localizedPlaceholder:M,selectedOption:Y,selectedOptions:q,mergedSize:K,mergedDisabled:J,focused:v,activeWithoutMenuOpen:fe,inlineThemeDisabled:l,onTriggerInputFocus:Oe,onTriggerInputBlur:ve,handleTriggerOrMenuResize:qe,handleMenuFocus:Pe,handleMenuBlur:we,handleMenuTabOut:xe,handleTriggerClick:ge,handleToggle:S,handleDeleteOption:Z,handlePatternInput:je,handleClear:He,handleTriggerBlur:Re,handleTriggerFocus:Me,handleKeydown:Ae,handleMenuAfterLeave:ye,handleMenuClickOutside:ie,handleMenuScroll:Ue,handleMenuKeydown:Ae,handleMenuMousedown:Ge,mergedTheme:s,cssVars:l?void 0:Ne,themeClass:he==null?void 0:he.themeClass,onRender:he==null?void 0:he.onRender})},render(){return c("div",{class:`${this.mergedClsPrefix}-select`},c(zn,null,{default:()=>[c(In,null,{default:()=>c(yo,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,t;return[(t=(e=this.$slots).arrow)===null||t===void 0?void 0:t.call(e)]}})}),c(An,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===at.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>c(Rt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,t,n;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),wn(c(po,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(t=this.menuProps)===null||t===void 0?void 0:t.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:"medium",renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(n=this.menuProps)===null||n===void 0?void 0:n.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var o,l;return[(l=(o=this.$slots).empty)===null||l===void 0?void 0:l.call(o)]},action:()=>{var o,l;return[(l=(o=this.$slots).action)===null||l===void 0?void 0:l.call(o)]}}),this.displayDirective==="show"?[[xn,this.mergedShow],[bt,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[bt,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{Vn as F,Ao as N,Ln as V,po as a,wo as b,vo as c,Bn as g,De as h,Qe as m};
